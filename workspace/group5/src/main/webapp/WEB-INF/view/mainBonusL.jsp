...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="java.util.*,com.li.model.BonusItem"%>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarText">
				...
				<!-- <ul>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">GAME ITEM</a>
                    </li>
                    <li class="nav-item">
				...
				<a class="nav-link active" href="#"> <i
					class="fa-solid fa-user d-inline-block" style="color: white;"></i>
					<span style="color: white;"> ${managerBeans.userId }</span> <!-- 更改為管理員帳號名稱 --></a>
	...
	<div class="content">
		<div class="area">
			<div class="contentHeader">
				<div class="searchBar">
					<nav class="navbar ">
						<div class=" container-fluid">
							<a class="navbar-brand" style="font-size: 30px; color: white;">SHOP</a>
							<form class="d-flex" role="search" method="post"
								action="http://localhost:8080/Item/getDataByName">
								<input class="form-control me-2" type="search"
									placeholder="Search" aria-label="Search" name="itemName">
		...
		<script>
                        $(function () {
                            ...
                            < form method = "post" action = "http://localhost:8080/Item/GetAllData" >
                                <div>
                                    <input class="nav-link active" type="submit" name="getItem" value="ALL" />
                                </div>
                        </form >
                    </li >
                            <li class="nav-item">
                                <form action="http://localhost:8080/Item/html/insert.html">
                                    <div>
                                        <input class="nav-link " type="submit" name="insert" value="CREATE" />
                                    </div>
                                </form>
