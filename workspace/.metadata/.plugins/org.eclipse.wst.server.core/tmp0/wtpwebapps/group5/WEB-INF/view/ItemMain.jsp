...
body {
	...
	/* background-color: rgb(22, 22, 24);
                    background-image: url("https://images.unsplash.com/photo-1619170743049-4688803388b4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80");
	...
	<nav class="navbar navbar-expand-lg bg-body-tertiary navbar bg-dark"
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarText">
				...
				<!-- 更改為管理員帳號名稱 -->
				<form class="d-flex " method="post" action="http://localhost:8080/group5/Main/ManagerLogout">
		...
		<div class="area">
			<div class="contentHeader">
					...
					<nav class="navbar ">
						<div class=" container-fluid">
							<a class="navbar-brand link-light"
								href="http://localhost:8080/group5/gameitem.controller"
								style="font-size: 30px;">GAME ITEM</a>
							<form class="d-flex" role="search" method="post"
								action="getGameItemByName">
								<input class="form-control me-2" type="search"
									placeholder="道具名稱查詢" aria-label="Search" name="itemName">
				...
				<ul class="nav nav-tabs">
					<li class="nav-item">
						<form method="get" action="allGameItem">
							<div>
								<input class="nav-link active" type="submit" name="getAllData"
									value="ALL" /> <input type="hidden" name="action"
									value="getAllData" />
							</div>
						</form>
					</li>
					<li class="nav-item">
						<form method="post" action="newGameItem">
							<div>
								<input class="nav-link" type="submit" name="insert"
									value="NEW ITEM" /> <input type="hidden" name="action"
									value="new" />
							</div>
						</form>
					</li>
	...
	<script>
		$(function() {
			...
			$(window).scroll(function() {
				...
				let newHeight = asideHeight + winHeight;
