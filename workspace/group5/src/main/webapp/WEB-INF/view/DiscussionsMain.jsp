		...
		<div class="area">
			<div class="contentHeader">
				<div class="searchBar">
					<nav class="navbar ">
						<div class=" container-fluid">
							<a class="navbar-brand" style="font-size: 30px;">DISCUSSIONS</a>
							<form class="d-flex" role="search" method="post"
								action="GetDiscussionSelectUserName2">
								<input class="form-control me-2" type="search"
									placeholder="請輸入姓名" aria-label="Search" name="userName">
				...
				<ul class="nav nav-tabs">
					<li class="nav-item">
						...
						<form method="post" action="getAllDiscussions">
							<div>
								<input class="nav-link active" type="submit" name="userName"
									value="ALL" />
							</div>
						</form>
					</li>
					<li class="nav-item">
						<form action="http://localhost:8080/group5/getinsertdata">
							<div>
								<input class="nav-link " type="submit" name="insert"
									value="CREATE" />
							</div>
						</form> <!-- <a class="nav-link active" aria-current="page" href="#">Active</a> -->
					</li>
				</ul>
			</div>
		</div>
